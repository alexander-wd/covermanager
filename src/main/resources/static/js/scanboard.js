...
//	]
    ...
    for (var i = 0; i < points.length; i += 1) {
        ...
        marker.content=
//                '<p>'+covers[i].coverID+'</p>'+
				'<p>水面高度：'+covers[i].height+'</p>'+
				'<p>温度：'+covers[i].temperature+'</p>'+
				'<p>湿度：'+covers[i].humidity+'</p>'+
				'<p>日交通量：'+covers[i].daily_traffic+'</p>';
     ...
     */
     ...
     function select(e) {
         //设置层级、中心
         myMap.setZoomAndCenter(11,[e.poi.location.lng,e.poi.location.lat])
